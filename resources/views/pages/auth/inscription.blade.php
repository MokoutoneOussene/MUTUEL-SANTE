        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div id="step-1" class="step active">
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nom_jeune_fille" class="form-control" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <div class="radio-group">
                        ...
                        <label class="radio-option">
                            Marié
                            <input type="radio" name="situation_matrimoniale" value="Marié" required>
                            <span class="checkmark"></span>
                        </label>

                        <label class="radio-option">
                            Veuf(ve)
                            <input type="radio" name="situation_matrimoniale" value="Veuf(ve)" required>
                            <span class="checkmark"></span>
                        </label>

                        <label class="radio-option">
                            Célibataire
                            <input type="radio" name="situation_matrimoniale" value="Célibataire" required>
                            <span class="checkmark"></span>
                        </label>

                        <label class="radio-option">
                            Divorcé(e)
                            <input type="radio" name="situation_matrimoniale" value="Divorcé(e)" required>
                            <span class="checkmark"></span>
                        </label>
                    </div>
            ...
            <div id="step-2" class="step">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <label>N° RCCM</label>
                        <input type="text" name="num_rccm" class="form-control" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
            ...
            <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="date_obtention" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label>Institution ayant délivré</label>
                        <input type="text" name="intitution" class="form-control" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
...
.step-item {
    ...
    align-items: center;
    text-align: center;
    min-width: 80px; /* pour un bon espacement */
}
